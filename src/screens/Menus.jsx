    ...
    <ScrollView style={styles.container}>
      <View style={styles.profileContainer}>
        ...
        <View style={styles.profileInfo}>
          ...
          <Text style={styles.profileEmail}> <Icons name='email'/> &nbsp;Nayeem52334@gmail.com</Text>
          <Text style={styles.profilePhone}> <Icons name='call'/> &nbsp;016445456734</Text>
        </View>
      ...
      <View style={styles.menuContainer}>
        {menuItems.map((item, index) => (
          <TouchableOpacity key={index} style={styles.menuItem} onPress={() => handleMenuPress(item.label)}>
            ...
            <Icons name="keyboard-arrow-right" size={24} color={Colors.secondary} />
          </TouchableOpacity>
        ))}
      </View>
    </ScrollView>
